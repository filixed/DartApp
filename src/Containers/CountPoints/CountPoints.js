    ...
    return(
        <Container  >
           <ScoreButtons getScore={getScore} />
            <Row xs={4}>
              <Col></Col>
              <Button onClick={() => getScore(25)} variant={'success'}>25</Button>
              <Button onClick={() => getScore(50)} variant={'danger'}>50</Button>
            </Row>
            <Row xs={5}>
            ...
            <Row>
              ...
              {tableData.map((item, ids) =>
                <Trow key={ids} nr={item.nr} first={item.first} second={item.second} third = {item.third} />
